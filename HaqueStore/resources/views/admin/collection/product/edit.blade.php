    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="mb-0">Collections/Edit Products
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="small_description"  placeholder="small Description about product" class="form-control" rows="4">{{ $products->small_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                        ...
                                        <div col-md-3>
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="sale_tag" value="{{ $products->sale_tag }}" placeholder="Sale Tag" class="form-control"/>
                                            </div>
                                        </div>
                                        <div col-md-3>
                                            <div class="form-group">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="p_highlights" placeholder="High-Light Description" rows="4" class="form-control mt-3">{{ $products->p_highlights }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="p_details" placeholder="Product Details/Specification" rows="4" class="form-control mt-3">{{ $products->p_details }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_title" placeholder="Product Description" rows="4" class="form-control">{{ $products->meta_title }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="feature_products" {{ $products->feature_products== '1' ? 'checked' :'' }} class="form-control"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="offer_products" {{ $products->offer_products== '1' ? 'checked' :'' }} class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
